...

{
  ...
  function catWalk() { // Create a function called catWalk()
    ...
    if (key && loc >= (innerWidth - image.width) / 2) { // When the cat reaches the middle of the screen,
      ...
      image.src = 'https://media1.tenor.com/images/2de63e950fb254920054f9bd081e8157/tenor.gif?itemid=10561424' // replace the img with an image of a cat dancing(use this URL: https://tenor.com/StFI.gif),
      setTimeout(function () {
    ...
    if (loc >= innerWidth) { // When the cat reaches the right - hand of the screen
